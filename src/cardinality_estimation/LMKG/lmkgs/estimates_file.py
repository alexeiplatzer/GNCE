...
def check_network_estimates(
    ...
    save_path: str = None,
    data: list = None,
    training_progress: list = None,
    total_pred_times: list = None,
):
    ...
    for i in range(len(data)):
        ...
        # q_err_tmp = max(tmp_card_q_error_changed, true_cardinality[i]) /
        # min(tmp_card_q_error_changed ,true_cardinality[i])
