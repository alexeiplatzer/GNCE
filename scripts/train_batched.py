...
if __name__ == "__main__":
    ...
    for epoch in range(n_epochs):
        ...
        print(
            f"Epoch {epoch+1}, Train Loss: {avg_train_loss}, Avg Train Q-Error: {avg_train_q_error}"
        )
        ...
        print(
            f"Epoch {epoch+1}, Test Loss: {avg_test_loss}, Avg Test Q-Error: {avg_test_q_error}"
        )
        print("\n")
